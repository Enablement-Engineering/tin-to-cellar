...
Protocol version: 0.0.31
CellarPack version: 0.1.0
Feedback version: 0.2.0
The complete protocol, all JSON schemas and canonical proof program are included below. Use this revision throughout this run and repairs. Do not fetch protocol instructions or schemas. Record manifest.extensions["tin-to-cellar:protocol"] as {"revision":"0.0.31","cellarpackVersion":"0.1.0","feedbackVersion":"0.2.0"}.
...
END TIN TO CELLAR PROTOCOL 0.0.31
