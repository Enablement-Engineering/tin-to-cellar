...
it('keeps past import warnings separate from suspended print readiness', async () => {
  ...
  expect(screen.getByText('Import checks passed')).toBeInTheDocument()
  expect(screen.getByText('0 labels selected for printing')).toBeInTheDocument()
})
beforeEach(async () => {
...
it('identifies import history without changing the selected print job, and resets from Print labels', async () => {
  ...
  expect(screen.getByText('Review checks for label ZIPs you imported from your device. Community designs and the example pack are not listed. Choosing a report keeps your current print sheet.')).toBeVisible()
