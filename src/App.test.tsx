...
it('identifies import history without changing the selected print job, and resets from Print labels', async () => {
  ...
  expect(screen.getByText('These reports describe ZIPs you uploaded. Community selections and the example pack are not listed. Choosing a report does not change your labels or print sheet.')).toBeVisible()
