...
export default defineConfig({
  ...
  projects: [
    { name: 'usage', testMatch: '**/usage/**/*.pw.ts' },
    { name: 'usage-regressions', testMatch: '**/accessibility/beta-readiness.pw.ts', grep: /editorial pages and usage|canonical print intent/ },
  ],
