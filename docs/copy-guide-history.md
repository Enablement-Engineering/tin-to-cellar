# Historical website copy guide and audit

Archived September 15, 2026. This records an earlier workflow and its verification. References to Make a prompt and automatic hosted print guides are obsolete. Use [the current writer's guide](copy-guide.md) for new work. The test counts below apply only to that earlier audit.
