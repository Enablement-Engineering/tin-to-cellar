...
class DB implements GalleryDatabase {
    ...
    constructor(db = new DatabaseSync(':memory:')) { this.db = db; db.exec(readFileSync(new URL('../../migrations/gallery/0001_gallery.sql', import.meta.url), 'utf8'));db.exec(readFileSync(new URL('../../migrations/gallery/0002_agent_review.sql', import.meta.url), 'utf8'));db.exec(readFileSync(new URL('../../migrations/gallery/0003_audit_context.sql', import.meta.url), 'utf8')); db.exec(readFileSync(new URL('../../migrations/gallery/0004_upload_attempts.sql', import.meta.url), 'utf8')); db.exec(readFileSync(new URL('../../migrations/gallery/0005_label_metadata_v2.sql', import.meta.url), 'utf8')); db.exec(readFileSync(new URL('../../migrations/gallery/0010_image_previews.sql', import.meta.url), 'utf8')); db.exec("UPDATE gallery_settings SET intake=1,publication=1,serving=1; INSERT INTO gallery_tobaccos VALUES('test-blend','Test','Blend','[]',1,'fixture')"); }
