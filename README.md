...
2. Copy the prompt into a chat with web research, image generation, and ZIP creation tools. It includes the complete versioned protocol, both schemas and local proof program in one paste. ChatGPT Work has been used in the documented experiments; other providers are not yet verified end to end.
