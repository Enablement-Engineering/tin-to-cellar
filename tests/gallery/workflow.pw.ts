...
test('browser selects artwork, submits privately, reviewer publishes, public user imports and prints', async ({ page, browser, request }) => {
  ...
  await expect(reviewer.getByRole('button', { name: 'Remove from gallery' })).toBeVisible()
  ...
  await reviewer.getByRole('button', {name:'Remove from gallery'}).click()
  await reviewer.getByRole('button', {name:'Confirm removal'}).click()
